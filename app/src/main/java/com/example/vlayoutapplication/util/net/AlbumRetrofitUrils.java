...
public class AlbumRetrofitUrils implements InterWorkInterface {
    public static AlbumRetrofitUrils AlbumRetrofitUrils;
    private final ApiServer apiServer;

    public AlbumRetrofitUrils() {
    ...
    public static AlbumRetrofitUrils getInstance() {
        if (AlbumRetrofitUrils == null) {
            synchronized (AlbumRetrofitUrils.class) {
                if (AlbumRetrofitUrils == null) {
                    AlbumRetrofitUrils = new AlbumRetrofitUrils();
                }
            }
        }
        return AlbumRetrofitUrils;
    }
