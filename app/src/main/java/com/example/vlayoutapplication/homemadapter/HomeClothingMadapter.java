...
public class HomeClothingMadapter extends DelegateAdapter.Adapter {
    ...
    public HomeClothingMadapter(Context context, ArrayList<HomeBannerBean.DataBean.CategoryListBean> clothinglist, LayoutHelper layoutHelper) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        HomeBannerBean.DataBean.CategoryListBean goodsListBean = clothinglist.get(position);
