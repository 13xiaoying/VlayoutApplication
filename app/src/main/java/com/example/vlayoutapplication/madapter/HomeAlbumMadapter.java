...
public class HomeAlbumMadapter extends DelegateAdapter.Adapter {
    ...
    public HomeAlbumMadapter(Context context, ArrayList<HomeAlbumBean.DataBean.CategoryListBean> albumlist, GridLayoutHelper gridLayoutHelper) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        HomeAlbumBean.DataBean.CategoryListBean categoryListBean = albumlist.get(position);
